    ...
    <footer>
      <div className="footer-div">
        ...
        <h4 className="footer-h4">Explore</h4>
          ...
          <li><a href="#" onClick={()=>navigateToPagedetail("64835dc0752339739aa90982")} >Book Shelf</a></li>
          </ul>
        </div>
        <div>
        <h4 className="footer-h4">Meta Links</h4>
        <ul className="footer-content">
            <li><a href="#" onClick={()=>navigateToPagedetail("64835d77752339739aa9097f")} >About Us</a></li>
            {/* <li><a href="">Contact Us</a></li> */}
            <li><a href="#" onClick={()=>navigateToPagedetail("64835d85752339739aa90980")} >Advertise</a></li>
            <li><a href="#" onClick={()=>navigateToPagedetail("64835d9a752339739aa90981")} >Privacy Policy</a></li>
          </ul>
        </div>
        <div>
